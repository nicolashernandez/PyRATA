...
# """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  ...
  def test (self, description, method, lexicons, pattern, data, expected, loglevel):
    ''' 
    ...
    if method == 'search':
      result = pyrata_re.search(pattern, data, lexicons=lexicons, loglevel=loglevel)
      if result != None:
        result = result.group()
    elif method == 'findall':
      result = pyrata_re.findall(pattern, data, lexicons=lexicons, loglevel=loglevel)
    else:
  ...
  def test_match_at_the_sequence_begining_is_atomic_constraint(self, loglevel):
    ...
    self.test(description, method, lexicons, pattern, data, expected, loglevel)
...
#    expected = [ {'pos':'DT'}, {'pos':'JJ'}, {'pos':'JJ'}, {'pos':'JJ'}, {'pos':'NN'}]
  ...
  def test_findall_in_lexicons_atomic_class(self, loglevel):
  ...
  def test_findall_in_empty_lexicons_atomic_class(self, loglevel):
  ...
  def test_findall_in_multiple_lexicons_atomic_class(self, loglevel):
...
# """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  ...
  def __init__(self):
    ...
    self.test_findall_in_lexicons_atomic_class(myloglevel)
    self.test_findall_in_empty_lexicons_atomic_class(myloglevel)
    self.test_findall_in_multiple_lexicons_atomic_class(myloglevel)
